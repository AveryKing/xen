...
const CallToAction = () => {
    return (
        <motion.div
            ...
            className='font-ubuntu flex justify-between  w-full items-center bg-pink-50  py-10 lg:py-0'>
            <div className=' md:w-7/12 px-5 lg:px-10 space-y-5 text-center lg:mb-10'>
                ...
                <button className='hover:scale-105 hover:-rotate-2 hover:bg-pink-400  border w-32 px-4 mx-auto py-1 rounded-full bg-pink-500 text-white border-pink-500'>Join Now</button>
