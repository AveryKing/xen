    ...
    return (
        <div className='flex justify-between  items-center bg-pink-50  py-10 lg:py-0'>
            <div className='px-5 lg:px-10 space-y-5 text-center lg:mb-10'>
                <h1 className=' text-4xl md:text-5xl lg:text-6xl md:pl-10 '>Find Your <span className='underline decoration-wavy decoration-from-font underline-offset-auto'>Flow</span></h1>
                ...
                <h3 className='border w-32 px-4 mx-auto py-1 rounded-full bg-pink-500 text-white border-pink-500'>Join Now</h3>
